...
namespace lab_25_strings
{
    class Program
    {
        ...
        {
            string s01 = "hi there";
            // use array notion to get individual letters
            foreach(var c in s01)
            {
                Console.WriteLine(c);
            }
            // acess individual letters using array notation
           ...
           // String s03 = "there!";
            ...
            try
            {
                // don't use parse because it'll throw an exception and crash your computer
                int num02 = int.Parse("123soemtext");
                Console.WriteLine(num02);
                int num03 = int.Parse("sometext123soemtext");
                Console.WriteLine(num03);
                int num04 = int.Parse("soemtext");
